---
name: comment
description: Write effective code comments following principles from "A Philosophy of Software Design". Use when documenting code, reviewing comments, or improving existing documentation. Optionally accepts a file path or class name to narrow scope.
---
